...
## okay to find out the number of revisits for a unique plot, you have to use the CA_PLOT dataframe, CA_cond will just have one inventory for each plot because it is just telling us the conditions of that plot, mulitple rows for a plot in CA_cond due to diffe
```
